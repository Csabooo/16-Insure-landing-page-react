...
import bg_pattern_mobile from "../images/bg-pattern-mobile-nav.svg";
...
function Header() {
  ...
  if (isValid) {
    hamburgerMenu = (
      <div>
        <button className="hamburger" onClick={buttonHandler}>
          <svg
            className="mb-0"
            xmlns="http://www.w3.org/2000/svg"
            width="32"
        ...
        <div className="block w-screen absolute hamburgerMenuList top-[70px] left-0 pb-64 ">
          ...
          <div className=" absolute right-0 bottom-0 max-w-[500px] mx-auto">
            <img
              className="w-screen"
