...
function Main() {
  return (
    <div className="text-center mx-auto ">
      <img className="mx-auto w-screen" src={image_intro} alt="intro_mobile" />
      ...
      {/* --------------Find out more about------------------------------------------- */}
      <div className="purple mx-5 mb-32 relative">
        <img
          className="absolute right-0 top-0"
          src={pattern_how_we_work_mobile}
          alt="pattern_how_we_work_mobile"></img>
        <h1 className="relative z-20">Find out more about how we work</h1>
